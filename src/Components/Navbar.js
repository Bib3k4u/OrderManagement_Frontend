...
const Navbar = () => {
  return (
    <nav className='h-20 flex-no-wrap fixed top-0 flex w-full items-center justify-between bg-[#D0A2F7] backdrop-blur-sm py-2 shadow-lg lg:flex-wrap lg:justify-start lg:py-4'>
      <ul className='flex w-full justify-around font-semibold tracking-wider'>
        ...
        <Link to="/" className='hover:shadow-md'><li>Book Order</li></Link>
